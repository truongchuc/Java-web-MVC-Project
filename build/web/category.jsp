...
<html lang="en">
    ...
    <body>
                    ...
                    <form action="SearchServlet" class="w-full" method="get">
                        <div class="form-control">
                            ...
                            <input 
                                ...
                                placeholder="Search ..." 
                                type="text" 
                                class="search-input bg-white border-1 rounded-20 border-b3b3b3 pl-35"
                                >
                        </div>
                    </form>
                </div>
        ...
        <section id="product1" class="section-p1">
            <form action="CategoryServlet" method="get" class="sort-form">
            ...
            <div class="prod-cont">
                <c:forEach var="product" items="${productList}">
                    <div class="prod">
                        ...
                        <div class="des">
                            <span>${product.categoryName}</span> <!-- Display the category name dynamically -->
                            <h5>${product.name}</h5>
                            <div class="star">
