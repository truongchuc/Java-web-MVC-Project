            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="single-pro-img">
                        <img src="${pageContext.request.contextPath}${product.thumbnail}" alt="${product.name}" id="MainImg" width="100%">
                        <div class="small-img-group">
                            <!-- Ensure the small images are either dynamic or correctly hardcoded -->
                            <div class="col-sm-3">
    ...
    <section id="product1" class="section-p1">
        ...
        <div class="prod-cont">
            <c:forEach var="relatedProduct" items="${relatedProductList}">
                <div class="prod">
                    <a href="ProductServlet?productId=${relatedProduct.id}&categoryId=${relatedProduct.categoryId}" class="product-image-wrap-link">
                        <img src="${pageContext.request.contextPath}${relatedProduct.thumbnail}" alt="${relatedProduct.name}" class="product-image">
                    </a>
                    <div class="des">
                        <span>adidas</span>
