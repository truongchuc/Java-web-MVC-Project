                    ...
                    <div class="col-12">
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <form action="CreateUserServlet" method="post">
                                ...
                                <div class="mb-3">
                                    <label for="exampleInputRepeatPassword" class="form-label">Re-enter Password</label>
                                    <input name="repeatPass" type="password" class="form-control" id="exampleInputRepeatPassword">
                                </div>
                                <div class="mb-3">
